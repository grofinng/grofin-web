// Nigeria — 36 states + FCT and their Local Government Areas.
// Offline fallback for src/api/geo.ts when the CountriesNow API is unreachable.
...
export function lgasForState(stateName: string): string[] {
